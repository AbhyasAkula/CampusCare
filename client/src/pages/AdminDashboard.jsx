        ...
        <div className="portal-panel overflow-hidden">
          {recentComplaints.length === 0 ? (
            <div className="flex flex-col items-center justify-center px-6 py-14 text-center">
              ...
              <p className="mt-3 text-sm font-semibold text-brandText">No complaints yet</p>
              <p className="mt-1 text-xs text-brandText-muted">Submitted tickets will appear here.</p>
            </div>
          ) : (
